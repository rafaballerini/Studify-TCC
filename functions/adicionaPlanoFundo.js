...
Se deseja alterar o ambiente que está utilizando no momento, use o comando **/alterarambiente**`);
        } else {
...
Para alterar o ambiente que está utilizando no momento, para o que acabou de comprar, use o comando **/alterarambiente**`);
        }
    },
};